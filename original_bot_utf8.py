...
class BotLogic:
    def __init__(self):
        ...
        self.labels = {
            "menu_about": {"uz": "≡ƒÅ½ Biz haqimizda", "en": "≡ƒÅ½ About us", "ru": "≡ƒÅ½ ╨₧ ╨╜╨░╤ü"},
            "menu_contact": {"uz": "≡ƒÆ¼ Biz bilan bog'lanish", "en": "≡ƒÆ¼ Contact us", "ru": "≡ƒÆ¼ ╨í╨▓╤Å╨╖╨░╤é╤î╤ü╤Å"},
            "menu_jobs": {"uz": "≡ƒÆ╝ Bo'sh ish o'rinlari", "en": "≡ƒÆ╝ Job vacancies", "ru": "≡ƒÆ╝ ╨Æ╨░╨║╨░╨╜╤ü╨╕╨╕"},
            "menu_lang": {"uz": "≡ƒîÉ Tilni almashtirish", "en": "≡ƒîÉ Change language", "ru": "≡ƒîÉ ╨í╨╝╨╡╨╜╨╕╤é╤î ╤Å╨╖╤ï╨║"},
            "back": {"uz": "Γ¼à∩╕Å Orqaga", "en": "Γ¼à∩╕Å Back", "ru": "Γ¼à∩╕Å ╨¥╨░╨╖╨░╨┤"},
            "cancel": {"uz": "Γ¥î Bekor qilish", "en": "Γ¥î Cancel", "ru": "Γ¥î ╨₧╤é╨╝╨╡╨╜╨░"},
            "skip": {"uz": "O'tkazib yuborish", "en": "Skip", "ru": "╨ƒ╤Ç╨╛╨┐╤â╤ü╤é╨╕╤é╤î"},
            "send_contact": {"uz": "Kontaktni yuborish", "en": "Send contact", "ru": "╨₧╤é╨┐╤Ç╨░╨▓╨╕╤é╤î ╨║╨╛╨╜╤é╨░╨║╤é"},
            "lang_uz": {"uz": "≡ƒç║≡ƒç┐ UZ", "en": "≡ƒç║≡ƒç┐ UZ", "ru": "≡ƒç║≡ƒç┐ UZ"},
            "lang_en": {"uz": "≡ƒç¼≡ƒçº ENG", "en": "≡ƒç¼≡ƒçº ENG", "ru": "≡ƒç¼≡ƒçº ENG"},
            "lang_ru": {"uz": "≡ƒç╖≡ƒç║ RUS", "en": "≡ƒç╖≡ƒç║ RUS", "ru": "≡ƒç╖≡ƒç║ RUS"},
        }
    ...
    def handle_update(self, update):
        ...
        if action in ["lang_uz", "lang_en", "lang_ru"]:
            ...
            lang = new_lang
            send_msg(chat_id, "Γ£à Til o'zgartirildi.", self._main_menu(lang))
            return
        ...
        if step == "name":
            ...
            send_msg(chat_id, "Γ£à <b>Rahmat!</b> Arizangiz HR bo'limiga yuborildi.", self._main_menu(lang))
    ...
    def finish_and_send(self, user_id, data, file_id, f_type):
        ...
        report = (
            ...
            f"≡ƒæñ Nomzod: {data['name']}\n"
            f"≡ƒô₧ Tel: {data['phone']}\n"
            f"≡ƒÆ╝ Lavozim: {data['position']}\n"
            f"≡ƒô¥ Tajriba: {data['exp']}\n"
            f"≡ƒåö ID: {user_id}"
        )
